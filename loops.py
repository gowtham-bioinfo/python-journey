...
# most_common_languages = language_count.most_common(1)[0]

# print("Most Spoken Language :", most_common_languages[0])
# print("Count :", most_common_languages[1])
...
# most_common_language = lang_count.most_common(1)[0]
